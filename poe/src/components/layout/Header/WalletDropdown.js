...
const WalletDropdown = () => {
  const { walletBtc, walletEth, isWalletOpen, toggleWallet, closeWallet } = useContext(WalletContext);
  ...
  return (
    <DropdownContainer>
      ...
      >
        <WalletIcon>
          <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path d="M16.5 20.25V6C16.5 5.60218 16.342 5.22064 16.0607 4.93934C15.7794 4.65804 15.3978 4.5 15 4.5H6.75C6.35218 4.5 5.97064 4.65804 5.68934 4.93934C5.40804 5.22064 5.25 5.60218 5.25 6V8.25" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
            <path d="M20.25 12.75H16.5C15.672 12.75 15 13.422 15 14.25C15 15.078 15.672 15.75 16.5 15.75H20.25" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
          </svg>
        </WalletIcon>
        <WalletAmount>
      ...
      >
        ...
        <WalletActions>
          <WalletAction className="interactive-element" onClick={handleActionClick}>
            <ActionIcon>
          ...
          <WalletAction className="interactive-element" onClick={handleActionClick}>
            <ActionIcon>
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M4 4H20M4 8H20M4 12H20M4 16H12M4 20H12" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
              </svg>
            </ActionIcon>
        ...
        <ManageWalletBtn className="interactive-element" onClick={handleActionClick}>
          管理钱包
        </ManageWalletBtn>
      </WalletMenu>
    </DropdownContainer>
